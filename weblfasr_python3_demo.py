...
lfasr_host = 'https://raasr.xfyun.cn/api'
...
if __name__ == '__main__':
    api = RequestApi(appid="5ed85be3", secret_key="52d5751d425902e9577b07c8bba61517", upload_file_path=r"test.mp3")
    api.all_api_request()
    result1=api.get_result_request(taskid='162e4ab3841549f186ebc7e212069543')
#taskid是各任务ID


    result_str=result1['data']

    result_dict2=json.loads(result_str)

    with open('doc.txt','w') as f:
        row=[]
        for i in result_dict2:

            row.append(i['onebest'])
        f.writelines(row)
    f.close()
